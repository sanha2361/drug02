                ...
                child:Column(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      ...
                      SizedBox(width:10.0),Text(widget.dc['system']),
                      SizedBox(width:10.0),Text(widget.dc['disease']),
                      SizedBox(width:10.0),Text(widget.dc['drugtype']),
                      SizedBox(width:10.0),Text(widget.dc['drugname']),
